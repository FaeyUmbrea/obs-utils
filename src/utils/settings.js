...
class OBSUtilsSettings extends TJSGameSettings {
    ...
    init() {
        ...
        settings.push(createSetting('minScale', {
            default: 0.1,
            type: Number,
            range: {
                min: 0.01,
        ...
        settings.push(createSetting('maxScale', {
            default: 2,
            type: Number,
            range: {
                min: 0.01,
        ...
        settings.push(createSetting('defaultOutOfCombat', {
            default: 'trackall',
            type: String,
            choices: OOCCHOICES,
            scope: 'world',
        ...
        settings.push(createSetting('defaultInCombat', {
            default: 'trackall',
            type: String,
            choices: ICCHOICES,
            scope: 'world',
        ...
        settings.push(createSetting('popupCloseDelay', {
            default: 10,
            type: Number,
            range: {
                min: 1,
        ...
        settings.push(createSetting('showTrackerInCombat', {
            default: false,
            type: Boolean,
            scope: 'world',
            config: true,
        }));
        settings.push(createSetting('trackedUser', {
            default: game.userId,
            type: String,
            scope: 'world',
            config: false,
        ...
        settings.push(createSetting('obsRemote', {
            type: Object,
            scope: 'world',
            config: false,
            default: new OBSRemoteSettings(),
        }));
        settings.push(createSetting('enableOBSWebsocket', {
            type: Boolean,
            scope: 'world',
            config: true,
            default: false,
        }));
        settings.push(createSetting('websocketSettings', {
            type: Object,
            scope: 'world',
            config: false,
            default: new OBSWebsocketSettings(),
        }));
        settings.push(createSetting('streamOverlays', {
            type: Object,
            scope: 'world',
            config: false,
            default: [],
        }));
        settings.push(createSetting('overlayActors', {
            type: Object,
            scope: 'world',
            config: false,
            default: [],
        }));
        settings.push(createSetting('settingsVersion', {
            type: Number,
            scope: 'world',
            config: false,
            default: 0
...
class RollOverlaySettings extends TJSGameSettings {
    ...
    init() {
        ...
        settings.push(createSetting('rollOverlayPreRollDelay', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayRollFadeIn', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayRollFadeOut', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayRollStay', {
            type: Number,
            scope: 'world',
            config: true,
            default: 5000
        }))
        settings.push(createSetting('rollOverlayPreRollFadeIn', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPreRollFadeOut', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPreRollStay', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPostRollFadeIn', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPostRollFadeOut', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPostRollStay', {
            type: Number,
            scope: 'world',
            config: true,
            default: 0
        }))
        settings.push(createSetting('rollOverlayPreRollImage', {
            type: String,
            scope: 'world',
            config: true,
            default: ""
        }))
        settings.push(createSetting('rollOverlayRollBackground', {
            type: String,
            scope: 'world',
            config: true,
            default: ""
        }))
        settings.push(createSetting('rollOverlayRollForeground', {
            type: String,
            scope: 'world',
            config: true,
            default: ""
        }))
        settings.push(createSetting('rollOverlayPostRollImage', {
            type: String,
            scope: 'world',
            config: true,
            default: ""
...
function createSetting(settingName, config) {
    return {
        namespace: moduleID, key: settingName, options: {
