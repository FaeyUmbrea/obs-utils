    ...
    <main>
        ...
        <div>
            {#each ic as {id, tooltip, icon}}
                <input type="radio" bind:group={currentIC} id="radioic{id}" name="currentIC" value={id}
        ...
        <div>
            ...
            <b>Tracked Player</b>
            <hr/>
            <select bind:value={currentTrackedPlayer} name="trackedPlayer" on:change={onChangePlayer}>
